...
if __name__ == "__main__":
    ...
    if train_mode:
        ...
        trainer.train(3000, save_dir="./results/cartpole/20210912_per_dualingdqn", file_name="cartpole", save_iter=1000, render=False)
    else:
        agent.remember(name="./results/cartpole/20210912_per_dualingdqn/cartpole_3000.pth")
        ''' Eval '''
